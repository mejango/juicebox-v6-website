...
var COMPONENT_SDK_STARTS = {
  ...
  launch: ['`/v6` `launch.ts`, `omnichain.ts`, `revnets.ts`: `buildLaunchProjectTx`, ruleset/terminal/accounting builders, `getProjectCreationFee`, `buildOmnichainLaunchProjectTx`, `buildDeployRevnetTx`.'],
  'queue-ruleset': ['`/v6` `rulesets.ts`, `omnichain.ts`: `buildQueueRulesetsTx`, `buildOmnichainQueueRulesetsTx`, current/upcoming reads, `RULESET_WEIGHT_INHERIT`.'],
  ...
  'items-for-sale': ['`/v6` `nft.ts`: shop/tier/price/721-metadata helpers; root `jb721TiersHookAbi` for `adjustTiers`.'],
